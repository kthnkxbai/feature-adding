...
class TenantService:
    def __init__(self):
        ...
        self.output_schema = TenantOutputSchema(many=True)
    ...
    def get_all_tenants(self, minimal=False):
        ...
        try:
            ...
            if minimal:
                ...
                dumped_tenants = self.output_schema.dump(tenants)
    ...
    def get_tenant_by_id(self, tenant_id):
        ...
        try:
            ...
            dumped_tenant = self.output_schema.dump(tenant) # Serialize the single model object
            print(f"DEBUG: TenantService.get_tenant_by_id({tenant_id}) returning: {dumped_tenant}")
            return self.output_schema.dump(tenant)
    ...
    def create_tenant(self, data):
        ...
        try:
            ...
            return self.output_schema.dump(new_tenant_obj)
    ...
    def update_tenant(self, tenant_id, organization_code_param, sub_domain_param, data):
        ...
        try:
            ...
            return self.output_schema.dump(updated_tenant_obj)
        except ValidationError:
            raise
        except NotFoundError: 
            raise
