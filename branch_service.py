...
class BranchService:
    ...
    def create_branch(self, tenant_id, branch_data):
        ...
        try:
            ...
            validated_data['tenant_id'] = tenant_id # Ensure tenant_id is set from URL param

            # Check for duplicate branch code within the tenant
    ...
    def update_branch(self, branch_id, update_data):
        ...
        try:
            ...
            # Check for duplicate branch code if it's being updated and changed
            ...
            # Update branch object attributes
