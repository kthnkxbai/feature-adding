...
@tenant_web_bp.route("/tenants", methods=["GET"])
...
@tenant_web_bp.route("/tenants", methods=["POST"])
def create_tenant():
    """
...
@tenant_web_bp.route("/tenants/<int:tenant_id>/<organization_code>/<sub_domain>", methods=["GET"])
...
@tenant_web_bp.route("/tenants/<int:tenant_id>/<organization_code_param>/<sub_domain_param>", methods=["POST"])
