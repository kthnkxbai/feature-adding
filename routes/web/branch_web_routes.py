...
@branch_web_bp.route('/view/<int:tenant_id>')
...
@branch_web_bp.route('/<int:branch_id>/edit', methods=["GET"])
...
@branch_web_bp.route('/<int:branch_id>/edit', methods=["POST"])
...
@branch_web_bp.route('/create/<int:tenant_id>', methods=["GET"])
...
@branch_web_bp.route('/create/<int:tenant_id>', methods=["POST"])
